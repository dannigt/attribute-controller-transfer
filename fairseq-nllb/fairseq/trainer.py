...
class Trainer(object):
    ...
    def load_checkpoint(
        ...
        if last_optim_state is not None and not reset_optimizer:
            ...
            assert (
                last_optim["criterion_name"] == self.get_criterion().__class__.__name__ or
                # added to handle subclass, pass if one superclass matches with original model
                last_optim["criterion_name"] in [s.__name__ for s in self.get_criterion().__class__.__bases__]
